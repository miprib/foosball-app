...
namespace FoosballWcfHost
{
    ...
    [System.Runtime.Serialization.DataContractAttribute(Name="FoosballData", Namespace="http://schemas.datacontract.org/2004/07/FoosballWcfHost")]
    public partial class FoosballData : object
    {
...
[System.ServiceModel.ServiceContractAttribute(ConfigurationName="IFoosballService")]
public interface IFoosballService
{
    
    [System.ServiceModel.OperationContractAttribute(AsyncPattern=true, Action="http://tempuri.org/IFoosballService/SayHelloTo", ReplyAction="http://tempuri.org/IFoosballService/SayHelloToResponse")]
    ...
    [System.ServiceModel.OperationContractAttribute(AsyncPattern=true, Action="http://tempuri.org/IFoosballService/GetHelloData", ReplyAction="http://tempuri.org/IFoosballService/GetHelloDataResponse")]
    System.IAsyncResult BeginGetHelloData(FoosballWcfHost.FoosballData helloWorldData, System.AsyncCallback callback, object asyncState);
    
    FoosballWcfHost.FoosballData EndGetHelloData(System.IAsyncResult result);
}

[System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
public interface IFoosballServiceChannel : IFoosballService, System.ServiceModel.IClientChannel
{
}
...
public partial class GetHelloDataCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs
{
    ...
    public FoosballWcfHost.FoosballData Result
    {
        get
        {
            base.RaiseExceptionIfNecessary();
            return ((FoosballWcfHost.FoosballData)(this.results[0]));
        }
    }
}
...
[System.Diagnostics.DebuggerStepThroughAttribute()]
[System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
public partial class FoosballServiceClient : System.ServiceModel.ClientBase<IFoosballService>, IFoosballService
{
    ...
    public FoosballServiceClient()
    {
    }
    
    public FoosballServiceClient(string endpointConfigurationName) : 
            base(endpointConfigurationName)
    {
    }
    
    public FoosballServiceClient(string endpointConfigurationName, string remoteAddress) : 
            base(endpointConfigurationName, remoteAddress)
    {
    }
    
    public FoosballServiceClient(string endpointConfigurationName, System.ServiceModel.EndpointAddress remoteAddress) : 
            base(endpointConfigurationName, remoteAddress)
    {
    }
    
    public FoosballServiceClient(System.ServiceModel.Channels.Binding binding, System.ServiceModel.EndpointAddress remoteAddress) : 
    ...
    System.IAsyncResult IFoosballService.BeginSayHelloTo(string name, System.AsyncCallback callback, object asyncState)
    {
        return base.Channel.BeginSayHelloTo(name, callback, asyncState);
    }
    
    [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
    string IFoosballService.EndSayHelloTo(System.IAsyncResult result)
    {
    ...
    private System.IAsyncResult OnBeginSayHelloTo(object[] inValues, System.AsyncCallback callback, object asyncState)
    {
        ...
        return ((IFoosballService)(this)).BeginSayHelloTo(name, callback, asyncState);
    }
    
    private object[] OnEndSayHelloTo(System.IAsyncResult result)
    {
        string retVal = ((IFoosballService)(this)).EndSayHelloTo(result);
        return new object[] {
                retVal};
    }
    ...
    [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
    System.IAsyncResult IFoosballService.BeginGetHelloData(FoosballWcfHost.FoosballData helloWorldData, System.AsyncCallback callback, object asyncState)
    {
        return base.Channel.BeginGetHelloData(helloWorldData, callback, asyncState);
    }
    
    [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
    FoosballWcfHost.FoosballData IFoosballService.EndGetHelloData(System.IAsyncResult result)
    {
    ...
    {
        FoosballWcfHost.FoosballData helloWorldData = ((FoosballWcfHost.FoosballData)(inValues[0]));
        return ((IFoosballService)(this)).BeginGetHelloData(helloWorldData, callback, asyncState);
    }
    
    private object[] OnEndGetHelloData(System.IAsyncResult result)
    {
        FoosballWcfHost.FoosballData retVal = ((IFoosballService)(this)).EndGetHelloData(result);
        return new object[] {
                retVal};
    }
    ...
    public void GetHelloDataAsync(FoosballWcfHost.FoosballData helloWorldData)
    {
        this.GetHelloDataAsync(helloWorldData, null);
    }
    
    public void GetHelloDataAsync(FoosballWcfHost.FoosballData helloWorldData, object userState)
    {
    ...
    protected override IFoosballService CreateChannel()
    {
        return new FoosballServiceClientChannel(this);
    }
    
    private class FoosballServiceClientChannel : ChannelBase<IFoosballService>, IFoosballService
    {
        
        public FoosballServiceClientChannel(System.ServiceModel.ClientBase<IFoosballService> client) : 
                base(client)
        {
        }
        ...
        public System.IAsyncResult BeginGetHelloData(FoosballWcfHost.FoosballData helloWorldData, System.AsyncCallback callback, object asyncState)
        {
            object[] _args = new object[1];
        ...
        public FoosballWcfHost.FoosballData EndGetHelloData(System.IAsyncResult result)
        {
            object[] _args = new object[0];
            FoosballWcfHost.FoosballData _result = ((FoosballWcfHost.FoosballData)(base.EndInvoke("GetHelloData", _args, result)));
            return _result;
        }
    }
}
