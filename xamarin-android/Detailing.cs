...
namespace xamarin_android
{
    ...
    Mat topR = new Mat(frame, topRRect);
            ...
            */
            ...
            CvInvoke.InRange(frame, new ScalarArray(new MCvScalar(25, 45, 205)), new ScalarArray(new MCvScalar(75, 95, 255)), ball);  // išskiriam raudona spalva per tas tris eilutes
